...
with col2:
  st.markdown("[Carlos Melgar - Community Supportooooooor]()")
  st.markdown("[DeSci Round Operators]()")
  st.markdown("[Dune Analytics dashboard - Proof Of Stake by Vitalik Buterin - Digital Book ]()")
  st.markdown("[Eartbased soul]()")
  st.markdown("[Gitcoin Awareness and Female Founder Amplification]()")
  st.markdown("[Gitcoin Gas Optimization]()")
  st.markdown("[Gitcoin Onboarding with Regens Unite]()")
  st.markdown("[greenpill.network]()")
  st.markdown("[Indigenous Voices in Gitcoin by Mycelia]()")
  st.markdown("[ITU Blockchain]()")
  st.markdown("[Jimi Cohen - Gitcoin Radio]()")

with col3:
  st.markdown("[Jon Ruth - Discord and Telegram Superhero]()")
  st.markdown("[Kairos Research]()")
  ...
  st.markdown("[Karma]()")
  st.markdown("[Lefteris Karapetsas]()")
  st.markdown("[Mars - Gitcoin citizen]()")
  st.markdown("[OpenLore Library]()")
  st.markdown("[Owocki/Supermodular.xyz (FBO Gitcoin Matching Pool)]()")
  st.markdown("[Quadratic Trust - Anne Connelly]()")
  st.markdown("[ZER8's Gitcoin Citizen Round Application]()")
  st.markdown("[Zuzalu Gitcoin Hype Squad]()")
  st.markdown("[]()")
